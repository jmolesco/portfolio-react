...
import { Container, Row, Col, Badge, Button, Image,OverlayTrigger,Tooltip,ButtonToolbar } from 'react-bootstrap';
            ...
            <Container>
                <Row>
                    <Col md={{ span: 6, offset: 3 }}>
                        <h3><center><Image src={profile} className="profile" /></center></h3>

                        <p>Hi, I'm JM, a Senior Software Engineer from the Philippines. Take a look more!</p>
                    </Col>
                </Row>
                <Row>
                    <Col sm={12}>
                        <h3><center>About What I Do</center></h3>
                        <hr></hr>
                        <p>
